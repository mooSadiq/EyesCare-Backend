    ...
    def post(self, request):
        try:
           ...
           try:
               ...
               print(f"Doctor object: {doctor}")  # للتأكد من صحة الكائن
               user_doctor = doctor.user  # تأكد من أن doctor يحتوي على user
               print(f"User of doctor: {user_doctor}")  # التأكد من الوصول إلى doctor.user
