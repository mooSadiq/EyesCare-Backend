...
class DiseaseEnglishSerializer(serializers.ModelSerializer):
    ...
    def get_causes(self, obj):
        return {
            "paragraph": obj.causes_paragraph_en,
            "points": obj.causes_points_en.split(",") if obj.causes_points_en else []
        }

    def get_symptoms(self, obj):
        return {
            "paragraph": obj.symptoms_paragraph_en,
            "points": obj.symptoms_points_en.split(",") if obj.symptoms_points_en else []
        }

    def get_diagnosis_methods(self, obj):
        return {
            "paragraph": obj.diagnosis_methods_paragraph_en,
            "points": obj.diagnosis_methods_points_en.split(",") if obj.diagnosis_methods_points_en else []
        }

    def get_treatment_options(self, obj):
        return {
            "paragraph": obj.treatment_options_paragraph_en,
            "points": obj.treatment_options_points_en.split(",") if obj.treatment_options_points_en else []
        }

    def get_prevention_recommendations(self, obj):
        return {
            "paragraph": obj.prevention_recommendations_paragraph_en,
            "points": obj.prevention_recommendations_points_en.split(",") if obj.prevention_recommendations_points_en else []
        }
